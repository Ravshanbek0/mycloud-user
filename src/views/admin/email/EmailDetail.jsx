  ...
  return (
    <div className="mx-auto mt-9 max-w-6xl rounded-xl bg-white text-gray-900 shadow-lg dark:bg-[#111C44] dark:text-gray-100">
      <div className="mb-4 pb-4">
        <div className="mx-0 flex items-center justify-between border-b border-gray-300 px-0 py-2 dark:border-gray-700">
          <h2 className="px-6 py-3 text-lg font-semibold">
            [MyCloud] Добро пожаловать Nigora
          </h2>
          <button
            type="button"
          ...
          >
            ...
            <p className="px-2 text-sm">Back to email list</p>
          </button>
        </div>

        <div className="text-md mt-3 px-6">
          <p className="pb-2">
        ...
        <div className="mt-3 px-6">
          ...
          <p className="my-2">
            Спасибо, что зарегистрировались у нас. Ваша новая учетная запись
            настроена, и теперь вы можете войти в нашу клиентскую зону,
            используя данные ниже:
            <div className="my-2 pl-3">
              <strong>• Электронная почта:</strong> nigoratoyloqova5@gmail.com
              <br />
              <strong>• Пароль:</strong> Пароль, который вы выбрали при создании
              учетной записи.
            </div>
          </p>
          <p className="mt-1">
      ...
      <div className="px-6 py-3">
        ...
        <p className="my-2">
          Thank you for signing up with us. Your new account has been setup and
          you can now login to our client area using the details below:
          <div className="my-2 pl-3">
            <strong>• Email:</strong> nigoratoyloqova5@gmail.com <br />
            <strong>• Password:</strong> Пароль, который вы выбрали при создании
            учетной записи.
          </div>
        </p>
        <p className="mt-1">
