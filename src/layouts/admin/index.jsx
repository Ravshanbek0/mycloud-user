...
import EmailDetail from "views/admin/email/EmailDetail";
import EmailConfirmation from "views/admin/email/EmailConfirmation";
          ...
          <div className="h-full">
            ...
            <div className="pt-5s mx-auto mb-auto h-full min-h-[84vh] p-2 md:pr-2">
              <Routes>
                ...
                <Route path="email/EmailDetail" element={<EmailDetail />} />
                <Route
